 ...
 * 寻人启事的adapter
 */
public class MineVideoAdapter2 extends RecyclerView.Adapter<MineVideoAdapter2.myHoder> {

    private Context context;

    private List<Video> videos;

    public MineVideoAdapter2(Context context, List<Video> videos) {
    ...
    public myHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_mine_indexvideo2,parent,false);
    ...
    class myHoder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.videoitem_depart)
        TextView depart;
