...
import com.example.aisearch.ui.volunteer.action.zwactivity.face.ChooseDetectDegreeDialog;
import com.example.aisearch.ui.volunteer.action.zwactivity.face.common.Constants;
...
public class ChooseFunctionActivity2 extends BaseActivity {
    ...
    public void activeEngine(final View view) {
        ...
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public void subscribe(ObservableEmitter<Integer> emitter) {
                ...
                int activeCode = FaceEngine.activeOnline(ChooseFunctionActivity2.this, Constants.APP_ID, Constants.SDK_KEY);
                ...
                .subscribe(new Observer<Integer>() {
                    ...
                    public void onNext(Integer activeCode) {
                        ...
                        int res = FaceEngine.getActiveFileInfo(ChooseFunctionActivity2.this, activeFileInfo);
