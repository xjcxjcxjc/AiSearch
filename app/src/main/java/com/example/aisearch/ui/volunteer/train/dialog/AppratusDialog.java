 ...
 *
 */
public class AppratusDialog extends Dialog{
    private Context mContext;
    private ClickCallBack mCallBack;
    private String content;

    public AppratusDialog(@NonNull Context context, ClickCallBack mCallBack, String content) {
        super(context);
    ...
    public void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_appratus, null);
        setContentView(view);
