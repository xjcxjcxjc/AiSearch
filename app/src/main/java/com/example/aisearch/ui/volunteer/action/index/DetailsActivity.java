...
import com.example.aisearch.ui.volunteer.action.index.fragments.DetailsHostoryFragmet;
import com.example.aisearch.ui.volunteer.action.index.fragments.DetailsImptFragment;
import com.example.aisearch.ui.volunteer.action.index.fragments.DetailsTeamFragmet;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    private void initBtn(){
        rb1.setOnClickListener(v -> startActivity(new Intent(DetailsActivity.this, ClueActivity.class)));
        ...
        actionlist_finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isTaskRoot())
                    ...
                    startActivity(new Intent(DetailsActivity.this, LodingActivity.class));
                    finish();
                }
            }
        });
...
//                        "longitude"+Double.toString(myLastLatin.longitude-marker.getPosition().longitude));
                ...
                InActionUtils.drawTeamOnMap2(DetailsActivity.this, latitude1,longtitude1, mBaiduMap,
               0,R.mipmap.team_icon2,"4/7");

                InActionUtils.drawTeamOnMap2(DetailsActivity.this, latitude,longtitude, mBaiduMap,
