 ...
 *
 */
public class FindFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener {
    ...
    //fragment
    CommunityItemFragment communityItemFragment1;
...
//
//        return DataUtil.getCommunityData(getContext());
//
//    }
    ...
    protected void initFragment1(){
        ...
        if(communityItemFragment1 == null){
            communityItemFragment1 = new CommunityItemFragment(DataUtil.getCommunityData(getContext(), CommunityItems.TYPE.FIND,CommunityItems.GROUP.COMMEND));
    ...
    protected void initFragment2(){
        ...
        if(communityItemFragment2 == null){
            communityItemFragment2 = new CommunityItemFragment(DataUtil.getCommunityData(getContext(),CommunityItems.TYPE.FIND,CommunityItems.GROUP.EXPERIENCE));
    ...
    public void addContent(CommunityItems communityItem){
        communityItemFragment1.addContent(communityItem);
    }
