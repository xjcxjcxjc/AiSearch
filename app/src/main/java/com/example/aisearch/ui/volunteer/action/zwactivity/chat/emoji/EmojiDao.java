package com.example.aisearch.ui.volunteer.action.zwactivity.chat.emoji;

import com.example.aisearch.ui.volunteer.action.zwactivity.chat.MyApplication;
...
public class EmojiDao {
    ...
    public List<EmojiBean> getEmojiBean(){
        ...
        for(int i=1;i<20;i++){
            EmojiBean e = new EmojiBean();
            e.setId(i);
            e.setUnicodeInt(0x2B00);
            emojiBeanList.add(e);
        }
        System.out.println(emojiBeanList.size());
