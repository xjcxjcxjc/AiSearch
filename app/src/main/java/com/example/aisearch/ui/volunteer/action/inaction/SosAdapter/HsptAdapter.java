...
public class HsptAdapter extends RecyclerView.Adapter<HsptAdapter.myHoder> {


    private Context context;
    private List<SOSBulid> cops;

    public HsptAdapter(Context context, List<SOSBulid> cops) {
    ...
    public myHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_sos_hspt,parent,false);
