...
public class FaceDIalog extends Dialog {
    ...
    private LockDialog.ClickCallBack mCallBack;
    private String content;

    public FaceDIalog(@NonNull Context context, LockDialog.ClickCallBack mCallBack, String content) {
        super(context);
    ...
    public void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_face, null);
        setContentView(view);
