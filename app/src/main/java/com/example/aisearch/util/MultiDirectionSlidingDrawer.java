...
public class MultiDirectionSlidingDrawer extends ViewGroup {
    ...
    {  
        ...
        int handleId = a.getResourceId( R.styleable.MultiDirectionSlidingDrawer_handle2, 0 );
        if ( handleId == 0 ) { throw new IllegalArgumentException( "The handle attribute is required and must refer "
                + "to a valid child." ); }  
          
        int contentId = a.getResourceId( R.styleable.MultiDirectionSlidingDrawer_content2, 0 );
