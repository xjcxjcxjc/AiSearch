...
public class SettingMainActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.bt_get_no_disturb_global) {
