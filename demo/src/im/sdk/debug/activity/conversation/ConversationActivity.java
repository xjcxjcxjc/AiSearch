...
public class ConversationActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.bt_getConvList) {//本地获取会话列表不排序
