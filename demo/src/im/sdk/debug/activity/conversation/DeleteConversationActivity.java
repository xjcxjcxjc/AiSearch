...
public class DeleteConversationActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.bt_single_delete) {
            mTv_info.setText("");
        ...
        } else if (id == R.id.bt_group_delete) {
            mTv_info.setText("");
        ...
        } else if (id == R.id.bt_get_conversation) {
            conversation = getConversation(targetName, targetGidString);
            if (conversation != null) {
                mTv_info.setText("");
        ...
        } else if (id == R.id.bt_get_message) {
            getAllMessage(getConversation(targetName, targetGidString));
        } else if (id == R.id.bt_get_latest_message) {
            conversation = getConversation(targetName, targetGidString);
